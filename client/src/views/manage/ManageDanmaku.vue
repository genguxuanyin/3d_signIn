  ...
  <div class="fillcontain">
    ...
    <div class="table_container">
      ...
      >
        ...
        <el-table-column prop="message" label="消息" align="center" width="320">
          <template slot-scope="scope">
            <span>{{ scope.row.message.length>20 ? (scope.row.message.substring(0,20) + '...') : scope.row.message}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="createdAt" label="发送时间" align="center" width="220" sortable>
          <template slot-scope="scope">
...
import { getDanmakuList as _getDanmakuList } from "../../api/index";
export default {
  name: "manageUser",
  data() {
    return {
